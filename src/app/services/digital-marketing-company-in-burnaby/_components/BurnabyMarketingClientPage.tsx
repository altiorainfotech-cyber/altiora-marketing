...
import styles from "../digital-marketing-company-in-burnaby.module.css";
...
export default function BurnabyMarketingClientPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Search visibility strategies targeting local Burnaby keywords and service searches.",
      color: "#EC4899",
    },
    {
      icon: Monitor,
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-8 lg:px-10 relative overflow-hidden bg-[#010b22]">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              Understanding these patterns is essential to effective Burnaby marketing services.
            </motion.p>
          </div>
        </section>
        ...
        >
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <div className="space-y-4">
              {[
                { question: "How long does SEO take in Burnaby?", answer: "Usually 3–6 months depending on competition." },
