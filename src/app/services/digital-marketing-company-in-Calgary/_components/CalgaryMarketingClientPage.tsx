          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              ...
              <p className={`${styles.sectionDescription} !max-w-3xl mt-4`}>
                As a trusted <strong className="text-white">Digital Marketing Company in Calgary</strong>, we deliver measurable results through data&#8209;driven strategies tailored for local businesses.
              </p>
            </motion.div>
