...
import styles from "../digital-marketing-company-in-langley.module.css";
...
export default function LangleyMarketingClientPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Search visibility strategies targeting local Langley keywords and service searches.",
      color: "#EC4899",
    },
    {
      icon: Monitor,
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-center min-h-[500px] sm:min-h-[550px] md:min-h-[600px] lg:min-h-[650px]">
              ...
              >
                ...
                >
                  Your Digital Marketing Company in{' '}
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  <p className={`${styles.sectionDescription} !max-w-none relative z-10`}>
                    Langley is expanding rapidly. Businesses that establish strong online visibility early dominate their category. We help secure that position using search and conversion strategy.
                  </p>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-8 lg:px-10 relative overflow-hidden bg-[#010b22]">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              <h2 className={`${styles.sectionHeading} leading-tight max-w-4xl mx-auto`}>
                Market Reality in{' '}
                <span className={styles.gradientText}>Langley</span>
              </h2>
              <p className="text-white/60 text-base sm:text-lg leading-relaxed mt-4 max-w-2xl mx-auto">
                The local Langley market behaves differently from many cities:
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
              {[
                ...
                >
                  <div
                    className="relative h-full rounded-2xl overflow-hidden border transition-all duration-500 hover:translate-y-[-6px] p-6 text-center"
            ...
            >
              Understanding these patterns is essential to effective Langley marketing services.
            </motion.p>
          </div>
        </section>
        ...
        >
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {[
                { title: "Deep Market", subtitle: "Knowledge", text: "We combine local Langley insights with hands‑on execution — so you never have to manage multiple freelancers or agencies.", icon: Target, gradient: "from-[#f4cc6f] to-[#FF9F43]" },
                ...
                { title: "Goal‑Driven", subtitle: "Campaigns", text: "Every campaign is built around your specific business goals, target audience, and competitive landscape in the Langley market.", icon: BarChart3, gradient: "from-[#8B5CF6] to-[#EC4899]" },
                ...
                { title: "Long‑Term", subtitle: "Growth Focus", text: "We focus on sustainable growth, not short‑term gimmicks — making us the reliable partner Langley businesses choose to grow with.", icon: Zap, gradient: "from-[#EC4899] to-[#f4cc6f]" },
                { title: "Local", subtitle: "Expertise", text: "We understand the multicultural audience, competitive niches, and search behaviour unique to the Langley and BC market.", icon: Globe, gradient: "from-[#f4cc6f] to-[#10B981]" },
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        >
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <div className="space-y-4">
              {[
                { question: "How long does SEO take in Langley?", answer: "Usually 3–6 months depending on competition." },
