...
import styles from "../digital-marketing-company-in-indigenous.module.css";
...
export default function IndigenousMarketingClientPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Search visibility strategies targeting Indigenous community keywords and service searches.",
      color: "#EC4899",
    },
    {
      icon: Monitor,
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-center min-h-[500px] sm:min-h-[550px] md:min-h-[600px] lg:min-h-[650px]">
              ...
              >
                ...
                >
                  Grow awareness while preserving authenticity.
                </motion.p>
                  ...
                  {mounted && (
                    <>
                      ...
                      <div className="relative z-10 flex items-center justify-center">
                        ...
                        >
                          <Share2 className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 text-white" />
                        </motion.div>
                      </div>
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  <p className={`${styles.sectionDescription} !max-w-none relative z-10`}>
                    Effective communication for Indigenous organizations prioritizes trust, clarity, and community respect. We design strategies that increase visibility while maintaining cultural integrity.
                  </p>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-8 lg:px-10 relative overflow-hidden bg-[#010b22]">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              <h2 className={`${styles.sectionHeading} leading-tight max-w-4xl mx-auto`}>
                Market Reality in{' '}
                <span className={styles.gradientText}>Indigenous Communities</span>
              </h2>
              <p className="text-white/60 text-base sm:text-lg leading-relaxed mt-4 max-w-2xl mx-auto">
                Indigenous communities have unique marketing needs:
              </p>
            </motion.div>
            ...
            >
              Understanding these patterns is essential to effective Indigenous community marketing.
            </motion.p>
          </div>
        </section>
        ...
        >
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {[
                { title: "Cultural", subtitle: "Understanding", text: "We respect and incorporate Indigenous values and cultural sensitivity in all marketing strategies.", icon: Target, gradient: "from-[#f4cc6f] to-[#FF9F43]" },
                ...
                { title: "Community\u2011Focused", subtitle: "Approach", text: "Every campaign respects Indigenous sovereignty and community values while achieving business goals.", icon: BarChart3, gradient: "from-[#8B5CF6] to-[#EC4899]" },
                ...
                { title: "Long\u2011Term", subtitle: "Partnership", text: "We focus on sustainable growth and building lasting relationships with Indigenous communities.", icon: Zap, gradient: "from-[#EC4899] to-[#f4cc6f]" },
                { title: "Indigenous", subtitle: "Expertise", text: "We understand the unique needs, values, and opportunities within Indigenous business communities.", icon: Globe, gradient: "from-[#f4cc6f] to-[#10B981]" },
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        >
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <div className="space-y-4">
              {[
                { question: "How do you ensure cultural sensitivity?", answer: "We work closely with community leaders and incorporate Indigenous values in all strategies." },
