...
export default function SaaSApplicationDevelopmentClient() {

  const services = [
    {
      title: "Product Discovery and UX",
      description: "User research, journeys, wireframes, and high fidelity designs that convert.",
      icon: <Eye className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Multi Tenant Architecture",
      description: "Isolated data, per tenant configuration, usage metering, and quotas.",
      icon: <Users className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Backend and API Platform",
      description: "Well structured services, background jobs, caching, and webhooks.",
      icon: <Server className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Authentication and Authorization",
      description: "SSO, SAML, OAuth, role based access, and organization management.",
      icon: <Lock className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Subscriptions and Billing",
      description: "Trials, plans, proration, invoices, taxes, dunning, and finance exports.",
      icon: <CreditCard className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Data and Storage",
      description: "Schema design, migrations, encryption, backup, and recovery plans.",
      icon: <Database className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Analytics and Experimentation",
      description: "Event tracking, funnels, dashboards, and controlled experiments.",
      icon: <BarChart3 className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Support and Admin Tools",
      description: "Tenant admin console, impersonation, audit logs, and helpdesk flows.",
      icon: <Settings className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Security and Compliance",
      description: "Secrets, rate limits, logging, alerting, and policy enforcement.",
  ...
  const whyChoosePoints = [
    "Product strategy tied to clear KPIs and a measurable roadmap",
    "Proven patterns for multi tenant architectures and data isolation",
    "Security, privacy, and compliance designed from the start",
    "CI and CD with quality gates for smooth and frequent releases",
    "Ongoing support for performance, reliability, and customer success",
  ...
  const whyWorkWithUs = [
    {
      ...
      description: "Threat modeling, secure coding, and regular reviews at every stage.",
      icon: <Shield className="w-8 h-8" />
    },
    {
      title: "Transparent Collaboration",
      description: "We co create with your team and document every decision for clarity.",
      icon: <Eye className="w-8 h-8" />
    },
    {
      title: "Holistic Coverage",
      description: "Design, engineering, data, billing, and operations aligned to your goals.",
      icon: <Layers className="w-8 h-8" />
    },
    {
      title: "Long Term Partnership",
      description: "Roadmaps for growth, performance tuning, and developer enablement.",
      icon: <Users className="w-8 h-8" />
    },
    {
      title: "Trusted Delivery",
      description: "Predictable outcomes with stakeholder confidence and clean handover.",
    ...
    <div className="min-h-screen flex flex-col bg-[#010c22] text-[#F8FBFB] overflow-x-hidden w-full max-w-full">
      ...
      <section className="relative overflow-hidden text-white py-20 md:py-40 w-full max-w-full" style={{
        ...
        <div className="absolute inset-0" style={{ animation: "float 6s ease-in-out infinite", transformStyle: "preserve-3d" }}>
          <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/saas-application-development-hero.jpg" alt="SaaS Application Development" fill priority className="object-cover" />
        </div>
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center w-full max-w-full">
              <div className="lg:col-span-12 space-y-6 w-full max-w-full">
                ...
                <p className="text-xl sm:text-2xl text-white/90">
                  Build scalable SaaS platforms that grow with your business.
                </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-[#0B0D2A] to-[#0B0D2A] rounded-3xl p-8 md:p-12 border-2 border-[#F4CC6F]/30">
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 text-center">
              Why Choose Our SaaS Application Development?
            </h3>
      ...
      <DNAAnimation 
        ...
        description="Six meticulously crafted phases that transform complex requirements into scalable SaaS solutions."
        data={[
          { title: "Scoping and Kickoff", text: "Align goals, audience, success metrics, and launch milestones." },
          { title: "System & Design", text: "Define UX, tenancy model, system design, and data contracts." },
          { title: "Build and Integrations", text: "Implement frontend, backend, billing, identity, & third party services-tests." },
          { title: "Quality and Readiness", text: "Performance, accessibility, security reviews, and user acceptance testing." },
          { title: "Launch and Enablement", text: "CI and CD, monitoring, incident runbooks, and team handover." },
          { title: "Operate and Improve", text: "Track reliability and product KPIs, optimize cost, and ship enhancements on cadence." }
        ]}
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="relative p-6 sm:p-8 md:p-12 text-center rounded-2xl md:rounded-3xl border border-white/20 backdrop-blur-sm overflow-hidden">
            <div className="absolute inset-0">
              <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/saas-application-development-cta.jpg" alt="SaaS Application Development" fill className="object-cover rounded-3xl" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 max-w-3xl mx-auto text-base sm:text-lg mb-6 md:mb-8">
                Build scalable SaaS platforms that grow with your business. At Altiora Infotech, we pair deep technical engineering with clear commercial thinking to deliver solutions that are secure, scalable, and aligned to your KPIs.
              </p>
