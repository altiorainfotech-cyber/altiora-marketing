...
export default function CustomWebAppClient() {

  const services = [
    {
      title: "Product Discovery and UX",
      description: "User research, journeys, wireframes, and high-fidelity interfaces that convert.",
      icon: <Eye className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Frontend Engineering",
      description: "Responsive apps with React or Next.js, strong accessibility and Core Web Vitals.",
      icon: <Monitor className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Backend and API Platforms",
      description: "Well-structured services with REST or GraphQL, caching, and background jobs.",
      icon: <Server className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Database and Data Layer",
      description: "Schema design, migrations, performance tuning, and backup strategy.",
      icon: <Database className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Authentication and Authorization",
      description: "SSO, role-based access, sessions, and secure session management.",
      icon: <Lock className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Payments and Commerce",
      description: "Checkout flows, subscriptions, invoicing, and reconciliation.",
      icon: <CreditCard className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Content and Media Management",
      description: "Headless CMS, asset pipelines, search, and localization.",
      icon: <Layers className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Analytics and Experimentation",
      description: "Event tracking, dashboards, A/B testing, and attribution.",
      icon: <BarChart3 className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Security and Compliance",
      description: "Secrets management, audits, rate limiting, and logging with retention policies.",
  ...
  const whyChoosePoints = [
    "Product thinking with clear KPIs and roadmaps",
    "Modern stacks and patterns that your team can own",
    "Secure by design with privacy and compliance in mind",
    "Observability and CI/CD for smooth releases and fast fixes",
    "Ongoing support for performance, reliability, and feature growth",
  ...
  const whyWorkWithUs = [
    {
      ...
      description: "Threat modeling, secure coding, and regular reviews are standard.",
      icon: <Shield className="w-8 h-8" />
    },
    {
      title: "Transparent Collaboration",
      description: "We co-create with your team, share context, and document every decision.",
      icon: <Eye className="w-8 h-8" />
    },
    {
      title: "Holistic Coverage",
      description: "Design, engineering, data, and infrastructure aligned to your goals.",
      icon: <Layers className="w-8 h-8" />
    },
    {
      title: "Long-term Partnership",
      description: "Feature roadmaps, performance tuning, and developer enablement.",
    ...
    <div className="min-h-screen flex flex-col bg-[#010c22] text-[#F8FBFB] overflow-x-hidden w-full max-w-full">
      ...
      <section className="relative overflow-hidden text-white py-20 md:py-40 w-full max-w-full" style={{
        ...
        <div className="absolute inset-0" style={{ animation: "float 6s ease-in-out infinite", transformStyle: "preserve-3d" }}>
          <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/custom-web-application-development-hero.jpg" alt="Custom Web Application Development" fill priority className="object-cover" />
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-[#0B0D2A] to-[#0B0D2A] rounded-3xl p-8 md:p-12 border-2 border-[#F4CC6F]/30">
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 text-center">
              Why Choose Our Custom Web Application Development?
            </h3>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white text-center">
              Our Custom Web Application Development
            </h2>
          </div>
      ...
      <DNAAnimation 
        title="Our Web Application Process"
        description="A practical path from idea to dependable production. Six strategic phases that ensure your web application is built for scale, security, and long-term success."
        data={[
          { title: "Scoping and Kickoff", text: "Align goals, users, constraints, and success metrics." },
          { title: "System & Design", text: "Define UX, information architecture, and system design." },
          { title: "Build and Integrations", text: "Implement frontend, backend, and third-party services with tests." },
          { title: "Quality and Readiness", text: "Performance, accessibility, security checks, and user acceptance." },
          { title: "Launch and Enablement", text: "CI/CD, monitoring, incident playbooks, and team handover." },
          { title: "Operate and Improve", text: "Track reliability and product KPIs, ship enhancements on a cadence." }
        ]}
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="relative p-6 sm:p-8 md:p-12 text-center rounded-2xl md:rounded-3xl border border-white/20 backdrop-blur-sm overflow-hidden">
            <div className="absolute inset-0">
              <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/custom-web-application-development-cta.jpg" alt="Custom Web Application Development" fill className="object-cover rounded-3xl" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 max-w-3xl mx-auto text-base sm:text-lg mb-6 md:mb-8">
                Build scalable web applications that drive business growth. At Altiora Infotech, we pair deep technical engineering with clear commercial thinking to deliver solutions that are secure, scalable, and aligned to your KPIs.
              </p>
