...
export default function HeadlessCMSClient() {
  ...
  const services = [
    {
      ...
      description: "Design reusable types, fields, relationships, and metadata for discovery.",
      icon: <Database className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Editorial Workflows & Roles",
      description: "Draft → review → legal → publish flows with permissions and auditability.",
      icon: <GitBranch className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Localization & Multi-brand",
      description: "Translation pipelines, locales, variants, and brand governance.",
      icon: <Globe className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Omnichannel Delivery APIs",
      description: "GraphQL/REST content delivery with caching, webhooks, and edge CDNs.",
      icon: <Server className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Personalization & Experimentation",
      description: "Segments, feature flags, A/B tests, and rules tied to analytics.",
      icon: <Settings className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Media Management",
      description: "Asset pipelines, renditions, optimization, rights, and CDN strategy.",
      icon: <FileImage className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Previews & Staging",
      description: "True-channel previews, scheduled publishes, and rollback/archiving.",
      icon: <Eye className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Integrations",
      description: "Search, commerce, CRM, marketing automation, and DAM connectors.",
      icon: <Layers className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Analytics & Quality",
      description: "Content scorecards, broken-link checks, performance and SEO insights.",
  ...
  const mobileServices = [
    ...
    {
      title: "Media Management",
      icon: <FileImage className="w-8 h-8 text-[#f4cc6f]" />
    },
    {
      title: "Previews & Staging",
  ...
  const whyChoosePoints = [
    "Product-minded approach to content modeling and editorial UX",
    "API-first architectures that scale to many channels and teams",
    "Governance and quality controls with audit trails and SLAs",
    "Transparent documentation, enablement, and change management",
    "Ongoing support for performance, reliability, and editorial velocity",
    "Multi-language and localization support with workflow automation"
  ];

  const whyWorkWithUs = [
    {
      title: "Security First Approach",
      description: "Least-privilege access, secrets, PII handling, and compliance by design.",
      icon: <Shield className="w-8 h-8" />
    },
    {
      title: "Transparent Collaboration",
      description: "We co-create with editorial and engineering teams, documenting choices.",
      icon: <Eye className="w-8 h-8" />
    },
    {
      title: "Holistic Coverage",
      description: "Content strategy, platform engineering, integrations, and analytics end to end.",
      icon: <Layers className="w-8 h-8" />
    },
    {
      title: "Long-term Partnership",
      description: "Roadmaps for new channels, brands, and editorial productivity.",
      icon: <Users className="w-8 h-8" />
    },
    {
      title: "Trusted Delivery",
      description: "Predictable outcomes, clear ownership, and measurable impact.",
    ...
    <div className="min-h-screen flex flex-col bg-[#010c22] text-[#F8FBFB] overflow-x-hidden w-full max-w-full">
      ...
      <section className="relative overflow-hidden text-white py-20 md:py-40 w-full max-w-full" style={{
        ...
        <div className="absolute inset-0" style={{ animation: "float 6s ease-in-out infinite", transformStyle: "preserve-3d" }}>
          <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/headless-cms-content-ops-hero.jpg" alt="Headless CMS & Content Ops" fill priority className="object-cover" />
        </div>
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center w-full max-w-full">
              <div className="lg:col-span-12 space-y-6 w-full max-w-full">
                ...
                <p className="text-xl sm:text-2xl text-white/90">
                  Manage content efficiently with modern headless CMS solutions.
                </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-[#0B0D2A] to-[#0B0D2A] rounded-3xl p-8 md:p-12 border-2 border-[#F4CC6F]/30">
            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 text-center">
              Why Choose Our Headless CMS & Content Ops?
            </h3>
      ...
      <DNAAnimation 
        title="Our Headless CMS Process"
        description="Six strategic phases that transform your content operations into a scalable, omnichannel powerhouse. Our methodology ensures seamless content delivery across all platforms."
        data={[
          { title: "Discovery & Audit", text: "Stakeholders, channels, content inventory, pain points, and objectives." },
          { title: "Structure & Governance", text: "Content types, taxonomy, workflows, roles, and compliance rules." },
          { title: "Platform Architecture", text: "Choose headless vendor or build, define APIs, caching, and CDN." },
          { title: "Integration & Migration", text: "Build schemas, workflows, integrations; migrate content with QA." },
          { title: "Enablement & Launch", text: "Editor training, developer docs, previews, SLAs, and cutover plan." },
          { title: "Operate & Improve", text: "Monitor velocity and quality; iterate models, workflows, and performance." }
        ]}
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="relative p-6 sm:p-8 md:p-12 text-center rounded-2xl md:rounded-3xl border border-white/20 backdrop-blur-sm overflow-hidden">
            <div className="absolute inset-0">
              <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/headless-cms-content-ops-cta.jpg" alt="Headless CMS & Content Ops" fill className="object-cover rounded-3xl" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 max-w-3xl mx-auto text-base sm:text-lg mb-6 md:mb-8">
                Manage content efficiently with modern headless CMS solutions. At Altiora Infotech, we pair deep technical engineering with clear commercial thinking to deliver solutions that are secure, scalable, and aligned to your KPIs.
              </p>
