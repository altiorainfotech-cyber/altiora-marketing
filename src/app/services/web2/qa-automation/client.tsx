...
export default function QAAutomationClient() {

  const services = [
    {
      title: "Test Strategy & Architecture",
      description: "Coverage model by risk and value, test pyramid, environments, and data setup.",
      icon: <TestTube className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "UI Test Automation",
      description: "Stable web and mobile suites for critical user flows with resilient selectors.",
      icon: <Globe className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "API & Contract Testing",
      description: "Spec-driven tests, mocks, and consumer contracts to prevent breaking changes.",
      icon: <Server className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Performance & Load Testing",
      description: "Throughput, latency, and scalability checks with capacity insights.",
      icon: <Zap className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Data & ETL Validation",
      description: "Schema, transformation, and reconciliation tests for analytics reliability.",
      icon: <Database className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Security & Compliance Checks",
      description: "Basic SAST/DAST integration, auth flows, and policy verifications in CI.",
      icon: <Shield className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Test Data Management",
      description: "Synthetic datasets, anonymization, and seeded states for repeatability.",
      icon: <Lock className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "CI/CD Integration & Gates",
      description: "Quality thresholds, flaky test quarantine, and release blockers where needed.",
      icon: <GitBranch className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Reporting & Observability",
      description: "Dashboards, alerts, trend analysis, and defect leakage metrics.",
  ...
  const mobileServices = [
    {
      title: "Test Strategy & Architecture",
      icon: <TestTube className="w-8 h-8 text-[#f4cc6f]" />
    },
    {
      title: "UI Test Automation",
  ...
  const whyChoosePoints = [
    "Outcome-first strategy tied to clear coverage and quality KPIs",
    "Robust engineering: modular test design, data seeding, and CI integration",
    "Flake-resistant suites with parallel runs, retry logic, and smart waits",
    "Clear reporting: dashboards, error triage, root-cause and remediation guidance",
    "Ongoing enablement: maintain tests alongside features, not after",
    "API and database validation with automated data integrity checks"
  ];

  const whyWorkWithUs = [
    {
      title: "Security First Approach",
      description: "Quality and privacy controls embedded across environments and data.",
      icon: <Shield className="w-8 h-8" />
    },
    {
      title: "Transparent Collaboration",
      description: "We co-create with your engineers, pairing on patterns and documentation.",
      icon: <Eye className="w-8 h-8" />
    },
    {
      title: "Holistic Coverage",
      description: "UI, API, data, and performance automation wired into your CI/CD.",
      icon: <Layers className="w-8 h-8" />
    },
    {
      title: "Long-term Partnership",
      description: "Guardrails for sustainable maintenance and team enablement.",
      icon: <Users className="w-8 h-8" />
    },
    {
      title: "Trusted Delivery",
      description: "Predictable releases, fewer incidents, and measurable business impact.",
    ...
    <div className="min-h-screen flex flex-col bg-[#010c22] text-[#F8FBFB] overflow-x-hidden w-full max-w-full">
      ...
      <section className="relative overflow-hidden text-white py-20 md:py-40 w-full max-w-full" style={{
        ...
        <div className="absolute inset-0" style={{ animation: "float 6s ease-in-out infinite", transformStyle: "preserve-3d" }}>
          <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/qa-automation-hero.jpg" alt="Mobile Application Development" fill priority className="object-cover" />
        </div>
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center w-full max-w-full">
              <div className="lg:col-span-12 space-y-6 w-full max-w-full">
                ...
                <p className="text-xl sm:text-2xl text-white/90">
                  Ensure quality and reliability with comprehensive testing solutions.
                </p>
      ...
      <DNAAnimation 
        ...
        description="Six meticulously crafted phases that transform manual testing into automated quality pipelines. Our proven methodology ensures reliable, comprehensive, and maintainable test automation."
        data={[
          { title: "Discovery & Baseline", text: "Map user journeys, systems, risks, existing tests, and success metrics." },
          { title: "Strategy & Tooling", text: "Define test pyramid, select frameworks, environments, & data approach." },
          { title: "Foundation Build", text: "Create libraries, objects, fixtures, & pipelines; set coding standards." },
          { title: "Coverage Expansion", text: "Prioritize high-value flows; add API, performance, and data validations." },
          { title: "Hardening & CI Gates", text: "Parallelization, flake reduction, stability targets, and actionable reports." },
          { title: "Operate & Improve", text: "Maintain alongside features; track trends, reduce MTTR, and optimize cost/run time." }
        ]}
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="relative p-6 sm:p-8 md:p-12 text-center rounded-2xl md:rounded-3xl border border-white/20 backdrop-blur-sm overflow-hidden">
           <div className="absolute inset-0">
              <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/qa-automation-cta.jpg" alt="Mobile Application Development" fill className="object-cover rounded-3xl" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 max-w-3xl mx-auto text-base sm:text-lg mb-6 md:mb-8">
                Ensure quality and reliability with comprehensive testing solutions. At Altiora Infotech, we pair deep technical engineering with clear commercial thinking to deliver solutions that are secure, scalable, and aligned to your KPIs.
              </p>
