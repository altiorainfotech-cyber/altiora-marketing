...
export default function DevOpsConsultingClient() {

  const services = [
    {
      title: "CI/CD Enablement",
      description: "Trunk-based development, automated tests, gated releases, and rollbacks.",
      icon: <GitBranch className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Infrastructure as Code",
      description: "Repeatable environments with Terraform or Pulumi and policy as code.",
      icon: <Code2 className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Kubernetes & Containers",
      description: "Secure cluster design, workload orchestration, and multi-env promotion.",
      icon: <Server className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "GitOps & Environment Management",
      description: "Declarative config, drift detection, and consistent app lifecycle.",
      icon: <Settings className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Observability & SRE",
      description: "Logs, metrics, traces, SLOs, error budgets, and incident management.",
      icon: <Eye className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "DevSecOps",
      description: "Secrets, SAST/DAST/Dependency checks, image signing, and SBOMs.",
      icon: <Shield className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Release & Change Management",
      description: "Blue–green and canary strategies with progressive delivery.",
      icon: <Zap className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Cost & Performance Optimization",
      description: "Rightsizing, autoscaling, caching, and workload scheduling.",
      icon: <Gauge className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Developer Experience",
      description: "Golden paths, internal portals, templates, and self-serve tooling.",
  ...
  const mobileServices = [
    ...
    {
      title: "Cost & Performance Optimization",
      icon: <Gauge className="w-8 h-8 text-[#f4cc6f]" />
    }
  ];

  const whyChoosePoints = [
    "Practical experience across cloud, containers, and Kubernetes at scale",
    "Measurable improvements in lead time, change failure rate, and MTTR",
    "Strong platform engineering with clear SLOs and runbooks",
    "Security and compliance embedded across the pipeline",
    "Ongoing enablement so your teams can own and evolve the platform",
    "Cost optimization strategies with resource rightsizing"
  ];

  const whyWorkWithUs = [
    {
      title: "Security First Approach",
      description: "Least-privilege access, encryption, and policy enforcement from the start.",
      icon: <Shield className="w-8 h-8" />
    },
    {
      title: "Transparent Collaboration",
      description: "We co-create with your engineers and document decisions clearly.",
      icon: <Eye className="w-8 h-8" />
    },
    {
      title: "Holistic Coverage",
      description: "Code, pipeline, platform, and operations aligned under one plan.",
      icon: <Layers className="w-8 h-8" />
    },
    {
      title: "Long-term Partnership",
      description: "Coaching, enablement, and iterative improvements built in.",
      icon: <Users className="w-8 h-8" />
    },
    {
      title: "Trusted Delivery",
      description: "Predictable releases, resilient systems, and stakeholder confidence.",
    ...
    <div className="min-h-screen flex flex-col bg-[#010c22] text-[#F8FBFB] overflow-x-hidden w-full max-w-full">
      ...
      <section className="relative overflow-hidden text-white py-20 md:py-40 w-full max-w-full" style={{
        ...
        <div className="absolute inset-0" style={{ animation: "float 6s ease-in-out infinite", transformStyle: "preserve-3d" }}>
          <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/devops-consulting-hero.jpg" alt="DevOps Consulting" fill priority className="object-cover" />
        </div>
      ...
      <DNAAnimation 
        ...
        description="Six strategic phases that transform delivery pipelines into reliable, automated systems."
        data={[
          { title: "Discovery & Baseline", text: "Map value streams, constraints, current metrics, and goals." },
          { title: "Architecture & Plan", text: "Define target platforms, pipelines and adoption a plan." },
          { title: "Platform Build", text: "Provision cloud or hybrid, implement IaC, identity, and networking." },
          { title: "Pipeline & Guardrails", text: "Configure CI/CD, testing, security scans, policies, and approvals." },
          { title: "Monitoring & Readiness", text: "Wire logs, metrics, SLOs, playbooks, and on-call posture." },
          { title: "Operate & Improve", text: "Review KPIs, optimize reliability and cost, and enable teams." }
        ]}
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="relative p-6 sm:p-8 md:p-12 text-center rounded-2xl md:rounded-3xl border border-white/20 backdrop-blur-sm overflow-hidden">
            <div className="absolute inset-0">
              <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/devops-consulting-cta.jpg" alt="DevOps Consulting" fill className="object-cover rounded-3xl" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 max-w-3xl mx-auto text-base sm:text-lg mb-6 md:mb-8">
                Streamline development and deployment with modern DevOps practices. At Altiora Infotech, we pair deep technical engineering with clear commercial thinking to deliver solutions that are secure, scalable, and aligned to your KPIs.
              </p>
