...
export default function MobileAppDevelopmentClient() {
  ...
  const services = [
    {
      ...
      description: "Research, user flows, wireframes, and high-fidelity UI that converts.",
      icon: <Eye className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "iOS and Android Engineering",
      description: "Swift and Kotlin where native makes sense, or React Native for shared code.",
      icon: <Smartphone className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "APIs and Backend Services",
      description: "Well-structured endpoints, authentication, caching, and background tasks.",
      icon: <Server className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Offline-first and Sync",
      description: "Resilient local storage, conflict handling, and seamless data sync.",
      icon: <Database className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Payments and Subscriptions",
      description: "In-app purchases, billing, refunds, and ledger reconciliation.",
      icon: <CreditCard className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Notifications and Messaging",
      description: "Push, in-app messages, deep links, and preference controls.",
      icon: <Bell className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Security and Compliance",
      description: "Secure storage, device attestation, encryption, and audit logging.",
      icon: <Shield className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "Analytics and Experimentation",
      description: "Event tracking, funnels, A/B tests, and attribution reporting.",
      icon: <BarChart3 className="w-12 h-12" />,
      link: "/contact"
    },
    {
      title: "App Store Readiness",
      description: "Guideline checks, screenshots, listings, and release orchestration.",
  ...
  const mobileServices = [
    ...
    {
      title: "iOS and Android Engineering",
      icon: <Smartphone className="w-8 h-8 text-[#f4cc6f]" />
    },
    {
      title: "APIs and Backend Services",
    ...
    {
      title: "Notifications and Messaging",
      icon: <Bell className="w-8 h-8 text-[#f4cc6f]" />
    },
    {
      title: "Security and Compliance",
  ...
  const whyChoosePoints = [
    "Product thinking with clear KPIs and outcome-driven roadmaps",
    "Native and cross-platform expertise with strong UI guidelines",
    "Secure by design with privacy, permissions, and data protection",
    "Observability and CI/CD for smooth releases and quick rollbacks",
    "Ongoing support for performance, reliability, and feature growth",
    "App store optimization and compliance with platform guidelines"
  ];
  ...
  const whyWorkWithUs = [
    ...
    },
    {
      ...
      description: "Roadmaps, performance tuning, and developer enablement.",
    ...
    <div className="min-h-screen flex flex-col bg-[#010c22] text-[#F8FBFB] overflow-x-hidden w-full max-w-full">
      ...
      <section className="relative overflow-hidden text-white py-20 md:py-40 w-full max-w-full" style={{
        ...
        <div className="absolute inset-0" style={{ animation: "float 6s ease-in-out infinite", transformStyle: "preserve-3d" }}>
          <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/mobile-application-development-hero.jpg" alt="Mobile Application Development" fill priority className="object-cover" />
        </div>
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center w-full max-w-full">
              <div className="lg:col-span-12 space-y-6 w-full max-w-full">
                ...
                <p className="text-xl sm:text-2xl text-white/90">
                  Build native and cross-platform mobile apps that users love.
                </p>
      ...
      <DNAAnimation 
        ...
        description="A practical path from concept to dependable production."
        data={[
          { title: "Scoping and Kickoff", text: "Align goals, audiences, constraints, and success metrics." },
          { title: "System & Design", text: "Define UX, navigation, system design, and data contracts." },
          { title: "Build and Integrations", text: "Implement UI, APIs, and third-party services with automated tests." },
          { title: "Quality and Readiness", text: "Performance, accessibility, security reviews, and user acceptance." },
          { title: "Launch and Enablement", text: "CI/CD pipelines, monitoring, incident playbooks, and handover." },
          { title: "Operate and Improve", text: "Track reliability and product KPIs, ship enhancements on cadence." }
        ]}
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="relative p-6 sm:p-8 md:p-12 text-center rounded-2xl md:rounded-3xl border border-white/20 backdrop-blur-sm overflow-hidden">
            <div className="absolute inset-0">
              <Image src="https://pub-00cafda969bc42d5aac5365b6609f526.r2.dev/web2/mobile-application-development-cta.jpg" alt="Mobile Application Development" fill className="object-cover rounded-3xl" />
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 max-w-3xl mx-auto text-base sm:text-lg mb-6 md:mb-8">
                Build native and cross-platform mobile apps that users love. At Altiora Infotech, we pair deep technical engineering with clear commercial thinking to deliver solutions that are secure, scalable, and aligned to your KPIs.
              </p>
