...
import styles from "../digital-marketing-company-in-abbotsford.module.css";
...
export default function AbbotsfordMarketingClientPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Search visibility strategies targeting local Abbotsford keywords and service searches.",
      color: "#EC4899",
    },
    {
      icon: Monitor,
                  ...
                  {mounted && (
                    <>
                      ...
                      <div className="relative z-10 flex items-center justify-center">
                        ...
                        >
                          <Target className="w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-20 lg:h-20 text-white" />
                        </motion.div>
                      </div>
              ...
              <div className="flex flex-col items-center">
                ...
                >
                  <p className={`${styles.sectionDescription} !max-w-none relative z-10`}>
                    In Abbotsford, proximity heavily influences decisions. Appearing when nearby customers search is critical. We ensure your business is visible at the right moment.
                  </p>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-8 lg:px-10 relative overflow-hidden bg-[#010b22]">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              <h2 className={`${styles.sectionHeading} leading-tight max-w-4xl mx-auto`}>
                Market Reality in{' '}
                <span className={styles.gradientText}>Abbotsford</span>
              </h2>
              <p className="text-white/60 text-base sm:text-lg leading-relaxed mt-4 max-w-2xl mx-auto">
                The local Abbotsford market behaves differently from many cities:
              </p>
            </motion.div>
            ...
            >
              Understanding these patterns is essential to effective Abbotsford marketing services.
            </motion.p>
          </div>
        </section>
        ...
        >
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {[
                { title: "Deep Market", subtitle: "Knowledge", text: "We combine local Abbotsford insights with hands\u2011on execution \u2014 so you never have to manage multiple freelancers or agencies.", icon: Target, gradient: "from-[#f4cc6f] to-[#FF9F43]" },
                ...
                { title: "Goal\u2011Driven", subtitle: "Campaigns", text: "Every campaign is built around your specific business goals, target audience, and competitive landscape in the Abbotsford market.", icon: BarChart3, gradient: "from-[#8B5CF6] to-[#EC4899]" },
                ...
                { title: "Long\u2011Term", subtitle: "Growth Focus", text: "We focus on sustainable growth, not short\u2011term gimmicks \u2014 making us the reliable partner Abbotsford businesses choose to grow with.", icon: Zap, gradient: "from-[#EC4899] to-[#f4cc6f]" },
                { title: "Local", subtitle: "Expertise", text: "We understand the multicultural audience, competitive niches, and search behaviour unique to the Abbotsford and BC market.", icon: Globe, gradient: "from-[#f4cc6f] to-[#10B981]" },
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        >
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <div className="space-y-4">
              {[
                { question: "How long does SEO take in Abbotsford?", answer: "Usually 3\u20136 months depending on competition." },
