...
// Incoming DB shape (partial) for flexibility
interface IProcessStepFromDB {
  step?: number;
  title?: string;
  description?: string;
  details?: string;
  icon?: string; // icon name or lucide name
}
...
const defaultProcessSteps: ProcessStep[] = [
  {
    ...
    description: "Define goals, users, data sources, and success metrics.",
    icon: Target,
    ...
    centerContent: {
      title: "SCOPING & KICKOFF",
      subtitle: "Define goals, users, data sources, and success metrics.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Profile quality, engineer signals, and set contracts and SLAs.",
    icon: Database,
    ...
    centerContent: {
      title: "DATA & FEATURE DESIGN",
      subtitle: "Profile quality, engineer signals, and set contracts and SLAs.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Train, tune, and validate with cross-validation and holdouts.",
    icon: Cpu,
    ...
    centerContent: {
      title: "MODEL DEVELOPMENT",
      subtitle: "Train, tune, and validate with cross-validation and holdouts.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Calibrate metrics, fairness checks, and business impact mapping.",
    icon: CheckCircle,
    ...
    centerContent: {
      title: "EVALUATION & EXPLAINABILITY",
      subtitle: "Calibrate metrics, fairness checks, and business impact mapping.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Serve via APIs or jobs; enable CI/CD, monitoring, and alerts.",
    icon: Shield,
    ...
    centerContent: {
      title: "DEPLOYMENT & HARDENING",
      subtitle: "Serve via APIs or jobs; enable CI/CD, monitoring, and alerts.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Track drift and decay; retrain, refine features, and optimize cost/latency.",
    icon: RotateCcw,
    ...
    centerContent: {
      title: "OPERATE & IMPROVE",
      subtitle: "Track drift and decay; retrain, refine features, and optimize cost/latency.",
      details: [],
      features: []
    }
  },
...
const MachineLearningProcessPage: React.FC<MLProcessProps> = ({ processSteps: dynamicSteps }) => {
...
export default MachineLearningProcessPage;