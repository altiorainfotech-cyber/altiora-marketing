...
/** Your predictive analytics process content with top half-circle positioning. */
const processSteps: ProcessStep[] = [
  {
    id: 1,
    title: "Scoping & Kickoff",
    description: "Align objectives, metrics, data sources, and stakeholders.",
    icon: Target,
    ...
    centerContent: {
      title: "SCOPING & KICKOFF",
      subtitle: "Align objectives, metrics, data sources, and stakeholders.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Profile quality, engineer signals, and define contracts with SLAs.",
    icon: Database,
    ...
    centerContent: {
      title: "DATA & FEATURE DESIGN",
      subtitle: "Profile quality, engineer signals, and define contracts with SLAs.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Train, tune, and validate with holdouts; document assumptions and limits.",
    icon: Cpu,
    ...
    centerContent: {
      title: "MODEL DEVELOPMENT",
      subtitle: "Train, tune, and validate with holdouts; document assumptions and limits.",
      details: [],
      features: []
    }
  },
  {
    id: 4,
    title: "Decision Design & Pilot",
    description: "Map scores to actions, approvals, and thresholds; run controlled trials.",
    icon: CheckCircle,
    iconPath: "/images/icon/process-section/Decision.svg",
    gradient: "bg-gradient-to-br from-teal-500 to-cyan-500",
    angle: 108, // 108 degrees from top
    centerContent: {
      title: "DECISION DESIGN & PILOT",
      subtitle: "Map scores to actions, approvals, and thresholds; run controlled trials.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Serve via APIs and workflows; enable CI/CD, monitoring, alerts, and runbooks.",
    icon: Shield,
    ...
    centerContent: {
      title: "HARDENING & LAUNCH",
      subtitle: "Serve via APIs and workflows; enable CI/CD, monitoring, alerts, and runbooks.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Track drift and performance; retrain and optimize accuracy, latency, and cost.",
    icon: RotateCcw,
    ...
    centerContent: {
      title: "OPERATE & IMPROVE",
      subtitle: "Track drift and performance; retrain and optimize accuracy, latency, and cost.",
      details: [],
      features: []
    }
  },
...
interface PredictiveAnalyticsProcessProps {
...
function mapDbStepToProcess(dbStep: IProcessStepFromDB, index: number): ProcessStep {
  ...
  const iconPaths = [
    ...
    "/images/icon/process-section/Data.svg",
    "/images/icon/process-section/Model.svg",
    "/images/icon/process-section/Decision.svg",
...
const PredictiveAnalyticsProcessPage: React.FC<PredictiveAnalyticsProcessProps> = ({ processSteps: dynamicSteps }) => {
...
export default PredictiveAnalyticsProcessPage;