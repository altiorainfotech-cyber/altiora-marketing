...
import { FaBrain, FaChartLine, FaCog, FaEye, FaSync, FaRocket } from 'react-icons/fa';
...
function mapDbStepToProcess(dbStep: IProcessStepFromDB, index: number): ProcessStep {
  ...
  return {
    ...
    iconPath: (dbStep as any).iconPath || "/images/icon/process-section/Default.svg",
    gradient: gradients[index % gradients.length],
    angle: angles[index % angles.length],
    centerContent: {
      title: dbStep.title.toUpperCase(),
      subtitle: dbStep.description,
      details: dbStep.details_list || [],
      features: []
    }
  };
}

/** Your natural language processing process content with top half-circle positioning. */
const defaultProcessSteps: ProcessStep[] = [
  {
    id: 1,
    title: "Scoping and Kickoff",
    description: "Define goals, users, languages, data sources, and success metrics.",
    icon: Target,
    ...
    centerContent: {
      title: "SCOPING AND KICKOFF",
      subtitle: "Define goals, users, languages, data sources, and success metrics.",
      details: [],
      features: []
    }
  },
  {
    id: 2,
    title: "Data and Evaluation Design",
    description: "Build datasets, ground-truth labels, and quality measures.",
    icon: Database,
    ...
    centerContent: {
      title: "DATA AND EVALUATION DESIGN",
      subtitle: "Build datasets, ground-truth labels, and quality measures.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Configure retrieval, prompts, or fine-tuning and validate results.",
    icon: Cpu,
    ...
    centerContent: {
      title: "MODEL DEVELOPMENT",
      subtitle: "Configure retrieval, prompts, or fine-tuning and validate results.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Trial with real users, collect feedback, refine prompts and policies.",
    icon: CheckCircle,
    iconPath: "/images/icon/process-section/Pilot.svg",
    gradient: "bg-gradient-to-br from-teal-500 to-cyan-500",
    angle: 108, // 108 degrees from top
    centerContent: {
      title: "PILOT AND FEEDBACK",
      subtitle: "Trial with real users, collect feedback, refine prompts and policies.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Add monitoring, RBAC, CI and CD, and incident playbooks.",
    icon: Shield,
    ...
    centerContent: {
      title: "HARDENING AND LAUNCH",
      subtitle: "Add monitoring, RBAC, CI and CD, and incident playbooks.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Track accuracy and cost, manage drift, and expand use cases.",
    icon: RotateCcw,
    ...
    centerContent: {
      title: "OPERATE AND IMPROVE",
      subtitle: "Track accuracy and cost, manage drift, and expand use cases.",
      details: [],
      features: []
    }
  },
...
const NaturalLanguageProcessingProcessPage: React.FC<NLPProcessProps> = ({ processSteps: dynamicSteps }) => {
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="relative w-full max-w-5xl mx-auto h-[400px] sm:h-[500px] md:h-[600px]">
        ...
        {/* Responsive Icons */}
        {(stepsToUse as ProcessStep[]).map((step: ProcessStep, index: number) => (
          <HalfCircleIcon
            key={step.id}
            step={step}
...
export default NaturalLanguageProcessingProcessPage;