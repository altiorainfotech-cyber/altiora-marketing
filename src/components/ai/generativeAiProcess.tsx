...
const processSteps: ProcessStep[] = [
  {
    ...
    description: "Align goals, users, data sources, risks, and success metrics.",
    icon: Target,
    ...
    centerContent: {
      title: "SCOPING & KICKOFF",
      subtitle: "Align goals, users, data sources, risks, and success metrics.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Select models, retrieval strategy, security, and evaluation plan.",
    icon: Database,
    ...
    centerContent: {
      title: "ARCHITECTURE & DESIGN",
      subtitle: "Select models, retrieval strategy, security, and evaluation plan.",
      details: [],
      features: []
    }
  },
  {
    id: 3,
    title: "Build & Testing",
    description: "Implement orchestration, datasets, and guardrails; validate quality.",
    icon: Cpu,
    ...
    centerContent: {
      title: "BUILD & TESTING",
      subtitle: "Implement orchestration, datasets, and guardrails; validate quality.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Run controlled trials, collect user signals, refine prompts and policies.",
    icon: CheckCircle,
    ...
    centerContent: {
      title: "PILOT & FEEDBACK",
      subtitle: "Run controlled trials, collect user signals, refine prompts and policies.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Add monitoring, RBAC, CI/CD, incident playbooks; go live with confidence.",
    icon: Shield,
    ...
    centerContent: {
      title: "HARDENING & LAUNCH",
      subtitle: "Add monitoring, RBAC, CI/CD, incident playbooks; go live with confidence.",
      details: [],
      features: []
    }
  },
  {
    ...
    description: "Track accuracy, cost, latency; iterate on prompts, data, and UX.",
    icon: RotateCcw,
    ...
    centerContent: {
      title: "OPERATE & IMPROVE",
      subtitle: "Track accuracy, cost, latency; iterate on prompts, data, and UX.",
      details: [],
      features: []
    }
  },
...
interface GenerativeAiProcessProps {
...
function mapDbStepToProcess(dbStep: IProcessStepFromDB, index: number): ProcessStep {
  ...
  const iconPaths = [
    ...
    "/images/icon/process-section/Build.svg",
    "/images/icon/process-section/Pilot.svg",
...
export const GenerativeAiProcess: React.FC<GenerativeAiProcessProps> = ({ processSteps: dynamicSteps }) => {
